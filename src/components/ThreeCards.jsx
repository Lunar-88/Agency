      ...
      <div className="px-4 md:px-12 lg:px-24">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-white rounded-2xl shadow-lg p-6 sm:p-8 hover:shadow-xl transition">
            <h3 className="text-2xl font-bold mb-4 text-center text-gray-700">Our Key Services</h3>
            <ul className="space-y-3 text-md font-semibold text-gray-600 leading-relaxed">
              <li className="flex items-start gap-2">
                <CheckCircle className="text-green-600 w-10 h-6 mt-1" />
                <span><strong className='text-lg font-bold'>Web Development:</strong> We build custom websites designed to your business needs and goals.</span>
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle className="text-green-600 w-12 h-6 mt-1" />
                <span><strong className='text-lg font-bold'>E-commerce Development:</strong> Our ecommerce web design provides you online stores that drive sales.</span>
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle className="text-green-600 w-10 h-6 mt-1" />
                <span><strong className='text-lg font-bold'>SEO:</strong> We help you grow your brand's organic traffic via our world's leading SEO services.</span>
              </li>
            </ul>
          </div>

          <div className="bg-white rounded-2xl shadow-lg p-6 sm:p-8 hover:shadow-xl transition">
            <h3 className="text-2xl font-bold mb-4 text-center text-gray-700">Our Mission</h3>
            <ul className="space-y-3 text-md font-semibold text-gray-600 leading-relaxed">
              <li className="flex items-start gap-2">
                <CheckCircle className="text-green-600 w-10 h-6 mt-1" />
          ...
          <div className="bg-white rounded-2xl shadow-lg p-6 sm:p-8 hover:shadow-xl transition">
            <h3 className="text-2xl text-center font-bold mb-4 text-gray-800">Our Vision</h3>
            <ul className="space-y-3 text-md font-semibold text-gray-600 leading-relaxed">
              <li className="flex items-start gap-2">
                <CheckCircle className="text-green-600 w-12 h-6 mt-1" />
